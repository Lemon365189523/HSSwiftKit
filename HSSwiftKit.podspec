#
#  Be sure to run `pod spec lint HSSwiftKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "HSSwiftKit"
  spec.version      = "0.0.1"
  spec.summary      = "A short description of HSSwiftKit."
  # spec.description  = <<-DESC
  #                  DESC

  spec.homepage     = "http://EXAMPLE/HSSwiftKit"
  ...
  spec.author             = { "fanweijian" => "fanweijian@yanpin.cn" }
  # Or just: spec.author    = "fanweijian"
  # spec.authors            = { "fanweijian" => "fanweijian@yanpin.cn" }
  # spec.social_media_url   = "https://twitter.com/fanweijian"
